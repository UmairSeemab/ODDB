...
<style>
  ...
  <style>
    ...
    td{color:#999;}
    th { background: #fff;color:#157fda }
  </style>
               ...
               <div class="col-md-8 text-right custom-nav">
                  <div id="navbar" class="navbar-collapse collapse">
                     <ul class="nav navbar-nav d-flex justify-content-end">
                        <li><a class="active nav-li" href="index.php">Home</a></li>
      ...
      <div id="getintouch" class="section wb wow fadeIn" style="padding-bottom:0;margin-top: -70px;">
        ...
        <iframe src="   https://anatomy-part-2.vercel.app/" id="iframe3"  scrolling="no"></iframe>
         ...
         <footer id="footer" class="footer-area wow fadeIn">
            ...
            <div style="max-height:130px; overflow-y:auto; border:1px solid #ccc;">
            ...
            fetch("get_visitors.php")
               ...
               .then(data => {
                  ...
                  let visitors = data.slice(-15).reverse();

                  // Show total count (all visitors in JSON, not just 15)
